...
void AdmobHelper::displayInterstitial() {
	cocos2d::JniMethodInfo t;
	if (cocos2d::JniHelper::getStaticMethodInfo(t, AppActivityClassName, "displayInterstitial", "()V")) {
		t.env->CallStaticVoidMethod(t.classID, t.methodID);
		t.env->DeleteLocalRef(t.classID);
	}
}
...
void AdmobHelper::displayInterstitial() {
	CCLOG("displayInterstitial() called");
	return; //nothing;
}
#endif
